    ...
    <div class="container" style="padding: 20px 30px 20px 30px">
        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" placeholder="Enter Table Seat" name="txtTableseat" required id="tableseat">
				</div>
			</div>
            <div class="form-group row">
            ...
            <div class="form-group">
				<div class="col-sm-12" align="center">
					<input type="submit" class="btn btn-default" name="btnCstock" style="background-color: #333;color: white" value="Submit">
				</div>
			</div>
        </form>
    </div>
